        ...
        try {
            ...
            this._config.forEach(field => {
                ...
                if (field.type === 'radio') {
                    ...
                    const fileInput = this._form.querySelector(
                        `input[type="file"][name="${field.name}"] , input[type="file"][name="${field.name}[]"]`
                    ...
                    const hasUrl = field.dropzoneOptions && typeof field.dropzoneOptions.url === 'string' && field.dropzoneOptions.url.length > 0;
                    if (!hasUrl && field.dropzoneInstance && typeof field.dropzoneInstance.getAcceptedFiles === 'function') {
                        const dzFiles: File[] = field.dropzoneInstance.getAcceptedFiles();
                        ...
                        const dzFilesFallback: File[] = field.dropzoneInstance?.getAcceptedFiles?.() || [];
